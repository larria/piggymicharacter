...
.card-slide-enter-active, .card-slide-leave-active { transition: all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1); }
.card-slide-enter-from { opacity: 0; transform: translateX(100%) rotateY(-20deg) scale(0.8); }
.card-slide-leave-to { opacity: 0; transform: translateX(-100%) rotateY(20deg) scale(0.8); }
</style>