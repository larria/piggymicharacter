...
<template>
  <div 
    class="w-full h-full bg-cover bg-center bg-no-repeat relative overflow-hidden flex flex-col"
    :style="bgStyle" 
    @click.once="handleInteraction"
    @touchstart.once="handleInteraction"
  >
    <!-- 遮罩层，让文字更清晰 -->
